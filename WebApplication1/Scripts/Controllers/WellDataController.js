            ...
            wellDataContext.consultarDoctosGeofisicos(id, function (resp) {
                switch (resp.ressult) {
                    case "tgp":
                        ...
                        self.source_reg_geo = (source_reg_geo).substr(source_reg_geo.indexOf('Entregable de REGISTROS') -1, source_reg_geo.length);
                        //self.source_reg_geo = (source_reg_geo).substr(source_reg_geo.indexOf('Archivos_Welldata') - 1, source_reg_geo.length);
