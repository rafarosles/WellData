...
{
    //Este modelo hace referencia a la tabla de Cat Veracruz
    public class WellData_Cat_Veracruz
    {
    ...
    public class Resultado_Cat_Veracruz
    {
        public bool Error { get; set; }
        public string MensajeError { get; set; }
        public List<WellData_Cat_Veracruz> Resultado { get; set; }
